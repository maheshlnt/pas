(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === 'object' && typeof module === 'object')
    ...
    define('zoid', [], factory);
  else if (typeof exports === 'object') exports['zoid'] = factory();
  else root['zoid'] = factory();
    ...
    /******/ [
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        function isWebView() {
          ...
          return (
            /(iPhone|iPod|iPad|Macintosh).*AppleWebKit(?!.*Safari)/i.test(
              userAgent
            ) ||
        ...
        function isIECompHeader() {
          ...
          var mContent = window.document.querySelector(
        ...
        var promise_ZalgoPromise =
          ...
          (function () {
            ...
            ZalgoPromise.hash = function hash(promises) {
              ...
              return ZalgoPromise.all(
                Object.keys(promises).map(function (key) {
                  return ZalgoPromise.resolve(promises[key]).then(function (
                    value
                  ) {
                    result[key] = value;
                  });
            ...
            ZalgoPromise.onPossiblyUnhandledException = function onPossiblyUnhandledException(
              handler
            ) {
        ...
        function findChildFrameByName(win, name) {
          ...
          for (
            var _i11 = 0, _getFrames4 = getFrames(win);
            _i11 < _getFrames4.length;
            _i11++
          ) {
        ...
        function isParent(win, frame) {
          ...
          for (
            var _i13 = 0, _getFrames6 = getFrames(win);
            _i13 < _getFrames6.length;
            _i13++
          ) {
        ...
        function getFrameForWindow(win) {
          ...
          for (
            var _i21 = 0,
              _document$querySelect2 = document.querySelectorAll('iframe');
        ...
        // eslint-disable-next-line flowtype/no-weak-types
        var util_weakMapMemoizePromise = function weakMapMemoizePromise(
          method
        ) {
          var weakmap = new weakmap_CrossDomainSafeWeakMap(); // eslint-disable-next-line flowtype/no-weak-types
        ...
        function awaitFrameLoad(frame) {
          awaitFrameLoadPromises =
            awaitFrameLoadPromises || new weakmap_CrossDomainSafeWeakMap();
        ...
        function animate(element, name, clean, timeout) {
          ...
          return new promise_ZalgoPromise(function (resolve, reject) {
            ...
            startEvent = bindEvents(el, ANIMATION_START_EVENTS, function (
              event
            ) {
              // $FlowFixMe
        ...
        function fixScripts(el, doc) {
          ...
          for (
            var _i18 = 0, _querySelectorAll2 = querySelectorAll('script', el);
            _i18 < _querySelectorAll2.length;
            _i18++
          ) {
        ...
        function experiment(_ref) {
          var name = _ref.name,
            ...
            logTreatment =
              _ref$logTreatment === void 0 ? src_util_noop : _ref$logTreatment,
            _ref$logCheckpoint = _ref.logCheckpoint,
            logCheckpoint =
              _ref$logCheckpoint === void 0
                ? src_util_noop
                : _ref$logCheckpoint;
          ...
          if (throttle < sample) {
            ...
            sample >= 50 ||
            (sample <= throttle && throttle < sample * 2)
          ) {
          ...
          return {
            ...
            log: function log(checkpoint, payload) {
              ...
              if (
                isEventUnique(
                  name + '_' + treatment + '_' + JSON.stringify(payload)
                )
              ) {
                logTreatment({
                  name: name,
        ...
        function request(_ref) {
          ...
          return new promise_ZalgoPromise(function (resolve, reject) {
            ...
            xhr.addEventListener(
              'load',
              function xhrLoad() {
                var responseHeaders = parseHeaders(
        ...
        function wrapPromise(method, _temp) {
          ...
          var timer = setTimeout(function () {
            if (expected.length) {
              promises.push(
                promise_ZalgoPromise.asyncReject(
                  new Error('Expected ' + expected[0] + ' to be called')
                )
              );
            }
          }, timeout);
          ...
          var expectError = function expectError(name, fn) {
            ...
            return function expectErrorWrapper() {
              ...
              promises.push(
                promise_ZalgoPromise.resolve(result).then(function () {
        ...
        function global_getGlobal(win) {
          ...
          var global = (win['__post_robot_10_0_27__'] =
            win['__post_robot_10_0_27__'] || {});
          return global;
        }
        ...
        function initHello(_ref8) {
          var on = _ref8.on,
            send = _ref8.send;
          return globalStore('builtinListeners').getOrSet(
            'helloListener',
            function () {
        ...
        var SERIALIZER =
          ((_SERIALIZER = {}),
          (_SERIALIZER[TYPE.FUNCTION] = serializeFunction),
          (_SERIALIZER[TYPE.ERROR] = serializeError),
          (_SERIALIZER[TYPE.PROMISE] = serializePromise),
          (_SERIALIZER[TYPE.REGEX] = serializeRegex),
          (_SERIALIZER[TYPE.DATE] = serializeDate),
          (_SERIALIZER[TYPE.ARRAY] = serializeArray),
          (_SERIALIZER[TYPE.OBJECT] = serializeObject),
          (_SERIALIZER[TYPE.STRING] = serializeString),
          (_SERIALIZER[TYPE.NUMBER] = serializeNumber),
          (_SERIALIZER[TYPE.BOOLEAN] = serializeBoolean),
          (_SERIALIZER[TYPE.NULL] = serializeNull),
          _SERIALIZER); // $FlowFixMe
        ...
        var DESERIALIZER =
          ((_DESERIALIZER = {}),
          (_DESERIALIZER[TYPE.FUNCTION] = deserializeFunction),
          (_DESERIALIZER[TYPE.ERROR] = deserializeError),
          (_DESERIALIZER[TYPE.PROMISE] = deserializePromise),
          (_DESERIALIZER[TYPE.REGEX] = deserializeRegex),
          (_DESERIALIZER[TYPE.DATE] = deserializeDate),
          (_DESERIALIZER[TYPE.ARRAY] = deserializeArray),
          (_DESERIALIZER[TYPE.OBJECT] = deserializeObject),
          (_DESERIALIZER[TYPE.STRING] = deserializeString),
          (_DESERIALIZER[TYPE.NUMBER] = deserializeNumber),
          (_DESERIALIZER[TYPE.BOOLEAN] = deserializeBoolean),
          (_DESERIALIZER[TYPE.NULL] = deserializeNull),
        ...
        function setupOpenTunnelToParent(_ref2) {
          ...
          global_getGlobal(
            window
          ).openTunnelToParent = function openTunnelToParent(_ref3) {
            var name = _ref3.name,
              source = _ref3.source,
              canary = _ref3.canary,
        ...
        function needsBridgeForBrowser() {
          if (
            utils_getUserAgent(window).match(/MSIE|trident|edge\/12|edge\/13/i)
          ) {
            return true;
          }
        ...
        function isBridge() {
          return Boolean(
            window.name && window.name === getBridgeName(utils_getDomain())
          );
        }
        ...
        function registerRemoteSendMessage(win, domain, sendMessage) {
          var sendMessageWrapper = function sendMessageWrapper(
            remoteWin,
            remoteDomain,
            message
          ) {
        ...
        function openTunnelToOpener(_ref) {
          ...
          return promise_ZalgoPromise.try(function () {
            ...
            return awaitRemoteBridgeForWindow(opener).then(function (bridge) {
              ...
              return global_getGlobal(assertSameDomain(bridge))
                .openTunnelToParent({
                  name: window.name,
                  source: window,
        ...
        var window_ProxyWindow =
          ...
          (function () {
            ...
            ProxyWindow.deserialize = function deserialize(
              serializedWindow,
              _ref8
            ) {
              var send = _ref8.send;
        ...
        function serializeWindow(destination, domain, win, _ref10) {
          ...
          return serializeType(
            ...
            window_ProxyWindow.serialize(win, {
              send: send
            })
          );
        }
        ...
        function serializeMessage(destination, domain, obj, _ref) {
          ...
          return serialize(
            obj,
            ((_serialize = {}),
            (_serialize[TYPE.PROMISE] = function (val, key) {
        ...
        function deserializeMessage(source, origin, message, _ref2) {
          ...
          var on = _ref2.on,
            send = _ref2.send;
          return deserialize_deserialize(
            message,
            ((_deserialize = {}),
            (_deserialize[
              SERIALIZATION_TYPE.CROSS_DOMAIN_ZALGO_PROMISE
            ] = function (serializedPromise) {
              return promise_deserializePromise(
                source,
                origin,
                serializedPromise
              );
            }),
            (_deserialize[SERIALIZATION_TYPE.CROSS_DOMAIN_FUNCTION] = function (
              serializedFunction
            ) {
              return function_deserializeFunction(
                source,
                origin,
                serializedFunction,
                {
            ...
            (_deserialize[SERIALIZATION_TYPE.CROSS_DOMAIN_WINDOW] = function (
              serializedWindow
            ) {
        ...
        SEND_MESSAGE_STRATEGIES[SEND_STRATEGY.POST_MESSAGE] = function (
          win,
          serializedMessage,
          domain
        ) {
        ...
        if (true) {
          SEND_MESSAGE_STRATEGIES[SEND_STRATEGY.BRIDGE] = function (
            win,
            serializedMessage,
            domain
          ) {
        ...
        if (true) {
          SEND_MESSAGE_STRATEGIES[SEND_STRATEGY.GLOBAL] = function (
            win,
            serializedMessage
          ) {
        ...
        function send_sendMessage(win, domain, message, _ref) {
          ...
          var serializedMessage = serializeMessage(
            ...
            domain,
            ((_serializeMessage = {}),
            (_serializeMessage['__post_robot_10_0_27__'] = _extends(
              {
                id: uniqueID(),
        ...
        function resetListeners() {
          ...
          var erroredResponseListeners = globalStore(
            'erroredResponseListeners'
          );
          ...
          for (
            ...
            if (domain && typeof domain === 'string') {
              ...
              if (domainListeners[__DOMAIN_REGEX__]) {
                for (
                  var _i6 = 0,
                    _domainListeners$__DO2 = domainListeners[__DOMAIN_REGEX__];
        ...
        var RECEIVE_MESSAGE_TYPES =
          ...
          (_RECEIVE_MESSAGE_TYPE[MESSAGE_TYPE.REQUEST] = function (
            source,
            origin,
            message,
            _ref
          ...
          (_RECEIVE_MESSAGE_TYPE[MESSAGE_TYPE.ACK] = function (
            source,
            origin,
            message
          ) {
          ...
          (_RECEIVE_MESSAGE_TYPE[MESSAGE_TYPE.RESPONSE] = function (
            source,
            origin,
            message
          ) {
            ...
            if (!matchDomain(options.domain, origin)) {
              throw new Error(
                'Response origin ' +
                  origin +
                  ' does not match domain ' +
                  stringifyDomainPattern(options.domain)
              );
            }
          ...
          return promise_ZalgoPromise
            ...
            .then(function (targetDomain) {
              ...
              if (!fireAndForget) {
                ...
                var totalAckTimeout = isWindowKnown(win)
                  ? ACK_TIMEOUT_KNOWN
                  : ACK_TIMEOUT;
        ...
        function cleanUpWindow(win) {
          ...
          for (
            var _i2 = 0, _requestPromises$get2 = requestPromises.get(win, []);
        ...
        function normalizeChildProps(
          ...
          if (!isUpdate) {
            for (
              var _i4 = 0, _component$getPropNam2 = component.getPropNames();
              _i4 < _component$getPropNam2.length;
              _i4++
            ) {
...
*/
        var child_ChildComponent =
          ...
          (function () {
            ...
            function ChildComponent(component) {
              ...
              promise_ZalgoPromise
                .try(function () {
                  ...
                  _this.parentComponentWindow = _this.getParentComponentWindow(
                    parent
                  );
                  _this.parentDomain = parentDomain;
                  _this.parent = setup_deserializeMessage(
                    _this.parentComponentWindow,
                    parentDomain,
                    exports
                  );
                  ...
                  var initialProps = _this.getPropsByRef(
                    _this.parentComponentWindow,
                    parentDomain,
                    props
                  );
            ...
            _proto.getPropsByRef = function getPropsByRef(
              parentComponentWindow,
              domain,
              _ref2
            ) {
            ...
            _proto.getParentComponentWindow = function getParentComponentWindow(
              ref
            ) {
              var type = ref.type;
              ...
              if (type === WINDOW_REFERENCES.OPENER) {
                ...
                return assertExists(
                  'parent',
                  getNthParentFromTop(window, ref.distance)
                );
              } else if (
            ...
            _proto.setProps = function setProps(props, origin, isUpdate) {
              ...
              var normalizedProps = normalizeChildProps(
              ...
              for (
                var _i4 = 0, _this$onPropHandlers2 = this.onPropHandlers;
                _i4 < _this$onPropHandlers2.length;
                _i4++
              ) {
...
*/
        function extendProps(component, props, inputProps, helpers, isUpdate) {
          ...
          for (
            var _i10 = 0, _component$getPropNam2 = component.getPropNames();
            _i10 < _component$getPropNam2.length;
            _i10++
          ) {
                      ...
                      .then(function (_ref) {
                        ...
                        if (typeof queryValue === 'boolean') {
                          ...
                          if (prop.serialization === PROP_SERIALIZATION.JSON) {
                            ...
                            prop.serialization === PROP_SERIALIZATION.BASE64
                          ) {
                            ...
                            for (
                              var _i12 = 0, _Object$keys6 = Object.keys(result);
                              _i12 < _Object$keys6.length;
                              _i12++
                            ) {
        ...
        var parent_ParentComponent =
          ...
          (function () {
            ...
            _proto.render = function render(target, container, context) {
              ...
              return promise_ZalgoPromise
                .try(function () {
                  ...
                  var uid =
                    ZOID + '-' + _this3.component.tag + '-' + uniqueID();
                  ...
                  var getProxyWindow = windowProp
                    ? promise_ZalgoPromise.resolve(
                        setup_toProxyWindow(windowProp)
                      )
                    : _this3.getProxyWindow();
                  var buildWindowName = getProxyWindow.then(function (
                    proxyWin
                  ) {
                  ...
                  var renderContainer = promise_ZalgoPromise
                    .hash({
                  ...
                  var openPrerender = promise_ZalgoPromise
                    .hash({
                      proxyWin: open,
                      proxyPrerenderFrame: openPrerenderFrame
                    })
                  ...
                  var prerender = promise_ZalgoPromise
                    .hash({
                  ...
                  var setWindowName = promise_ZalgoPromise
                    .hash({
                      proxyWin: open,
                      windowName: buildWindowName
                    })
                  ...
                  var loadUrl = promise_ZalgoPromise
                    .hash({
                      proxyWin: open,
                      url: buildUrl,
                  ...
                  var onDisplay = promise_ZalgoPromise
                    .hash({
                ...
                .catch(function (err) {
                  return promise_ZalgoPromise
                    .all([_this3.onError(err), _this3.destroy(err)])
                    .then(
                      function () {
                        throw err;
                      },
            ...
            _proto.getPropsRef = function getPropsRef(
              proxyWin,
              childDomain,
              domain,
              uid
              ...
              var value = setup_serializeMessage(
                proxyWin,
                domain,
                this.getPropsForChild(domain)
              );
              var propRef =
                childDomain === utils_getDomain()
                  ? {
            ...
            _proto.buildChildPayload = function buildChildPayload(_temp) {
              ...
              return {
                ...
                exports: setup_serializeMessage(
                  proxyWin,
                  domain,
                  this.buildParentExports(proxyWin)
                )
              };
            };
            ...
            _proto.getPropsForChild = function getPropsForChild(domain) {
              ...
              for (
                var _i2 = 0, _Object$keys2 = Object.keys(this.props);
                _i2 < _Object$keys2.length;
                _i2++
              ) {
                var key = _Object$keys2[_i2];
                ...
                if (
                  prop &&
                  prop.sameDomain &&
                  !matchDomain(domain, utils_getDomain(window))
                ) {
                  continue;
                }
            ...
            _proto.updateProps = function updateProps(props) {
              ...
              return this.initPromise.then(function () {
                if (_this9.child) {
                  return _this9.child
                    .updateProps(_this9.getPropsForChild(_this9.getDomain()))
                    .catch(function (err) {
            ...
            _proto.openPrerender = function openPrerender(
              proxyWin,
              proxyPrerenderFrame
            ) {
              var _this13 = this;
              ...
              return promise_ZalgoPromise.try(function () {
                return _this13.driver.openPrerender.call(
                  _this13,
                  proxyWin,
                  proxyPrerenderFrame
                );
            ...
            _proto.delegate = function delegate(context, target) {
              ...
              for (
                var _i4 = 0,
                  _this$component$getPr2 = this.component.getPropNames();
                _i4 < _this$component$getPr2.length;
                _i4++
              ) {
              ...
              var overridesPromise = send_send(
                target,
                POST_MESSAGE.DELEGATE + '_' + this.component.name,
                {
                  context: context,
                  props: props,
                  overrides: {
              ...
              for (
                var _i6 = 0, _this$driver$delegate2 = this.driver.delegate;
                _i6 < _this$driver$delegate2.length;
                _i6++
              ) {
            ...
            _proto.getWindowRef = function getWindowRef(
              target,
              domain,
              uid,
              context
            ...
            _proto.runTimeout = function runTimeout() {
              ...
              return promise_ZalgoPromise.try(function () {
                ...
                if (timeout) {
                  return _this19.initPromise.timeout(
                    timeout,
                    new Error(
            ...
            _proto.renderContainer = function renderContainer(
              ...
              return promise_ZalgoPromise
                ...
                .then(function (_ref20) {
                  ...
                  var innerContainer = _this27.renderTemplate(
                    _this27.component.containerTemplate,
                    {
                      context: context,
                      uid: uid,
                      container: container,
        ...
        var delegate_DelegateComponent =
          ...
          (function () {
            function DelegateComponent(component, source, options) {
              ...
              this.renderTemplate =
                parent_ParentComponent.prototype.renderTemplate; // $FlowFixMe

              this.props = {};

              for (
                var _i2 = 0, _Object$keys2 = Object.keys(options.props);
                _i2 < _Object$keys2.length;
                _i2++
              ) {
            ...
            _proto.watchForSourceClose = function watchForSourceClose(source) {
              ...
              var closeSourceWindowListener = onCloseWindow(
                source,
                function () {
            ...
            _proto.getOverrides = function getOverrides() {
              ...
              var _loop = function _loop(_i4, _this$driver$delegate2) {
                ...
                overrides[key] = function delegateOverride() {
                  // $FlowFixMe
                  return parent_ParentComponent.prototype[key].apply(
                    self,
                    arguments
                  );
                };
              ...
              for (
                var _i4 = 0, _this$driver$delegate2 = this.driver.delegate;
                _i4 < _this$driver$delegate2.length;
                _i4++
              ) {
        ...
        var angular = {
          register: function register(component, ng) {
            var module = ng
              ...
              .directive(dasherizeToCamel(component.tag), function () {
                var scope = {};

                for (
                  var _i2 = 0,
                    _component$getPropNam2 = component.getPropNames();
                  _i2 < _component$getPropNam2.length;
                  _i2++
                ) {
        ...
        function validate_validate(options) {
          ...
          if (
            (options.containerTemplate || !true) &&
          ...
          (function () {
            function Component(options) {
              ...
              this.allowedParentDomains =
                options.allowedParentDomains || src_constants_WILDCARD;
              ...
              var _ref = options.dimensions || {},
                ...
                width =
                  _ref$width === void 0 ? DEFAULT_DIMENSIONS.WIDTH : _ref$width,
            ...
            _proto.getPropNames = function getPropNames() {
              ...
              for (
                var _i2 = 0, _Object$keys2 = Object.keys(this.builtinProps);
                _i2 < _Object$keys2.length;
                _i2++
              ) {
                var key = _Object$keys2[_i2];
            ...
            _proto.canRenderTo = function canRenderTo(win) {
              return send_send(
                win,
                POST_MESSAGE.ALLOW_DELEGATE + '_' + this.name
              )
                .then(function (_ref3) {
                  var data = _ref3.data;
                  return data;
            ...
            _proto.isChild = function isChild() {
              ...
              return Boolean(
                payload &&
                  ...
                  payload.childDomain === utils_getDomain()
              );
            };

            _proto.getDefaultContainer = function getDefaultContainer(
              context,
              container
            ) {
              if (container) {
            ...
            _proto.getDefaultContext = function getDefaultContext(
              context,
              props
            ) {
              var _this2 = this;
              ...
              var _render = function render(target, container, context) {
                return promise_ZalgoPromise
                  ...
                  .then(function (finalContext) {
                    container = _this3.getDefaultContainer(
                      finalContext,
                      container
                    );
            ...
            _proto.checkAllowRender = function checkAllowRender(
              target,
              domain,
              container
            ) {
            ...
            _proto.registerActiveComponent = function registerActiveComponent(
              instance
            ) {
              var global = lib_global_getGlobal();
            ...
            _proto.destroyActiveComponent = function destroyActiveComponent(
              instance
            ) {
              var global = lib_global_getGlobal();
              global.activeComponents = global.activeComponents || [];
              global.activeComponents.splice(
                global.activeComponents.indexOf(instance),
                1
              );
            };
        ...
        function destroyAll() {
          ...
          while (global.activeComponents.length) {
            results.push(
              global.activeComponents[0].destroy(
        ...
        /* concated harmony reexport PopupOpenError */ __webpack_require__.d(
          __webpack_exports__,
          'PopupOpenError',
          function () {
        ...
        /* concated harmony reexport destroy */ __webpack_require__.d(
          __webpack_exports__,
          'destroy',
          function () {
        ...
        /* concated harmony reexport destroyComponents */ __webpack_require__.d(
          __webpack_exports__,
          'destroyComponents',
          function () {
        ...
        /* concated harmony reexport destroyAll */ __webpack_require__.d(
          __webpack_exports__,
          'destroyAll',
          function () {
            return destroyAll;
        ...
        /* concated harmony reexport PROP_TYPE */ __webpack_require__.d(
          __webpack_exports__,
          'PROP_TYPE',
          function () {
            return PROP_TYPE;
        ...
        /* concated harmony reexport PROP_SERIALIZATION */ __webpack_require__.d(
          __webpack_exports__,
          'PROP_SERIALIZATION',
          function () {
        ...
        /* concated harmony reexport CONTEXT */ __webpack_require__.d(
          __webpack_exports__,
          'CONTEXT',
          function () {
            return CONTEXT;
        ...
        /* concated harmony reexport EVENT */ __webpack_require__.d(
          __webpack_exports__,
          'EVENT',
          function () {
            return EVENT;
